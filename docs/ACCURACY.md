...
The project must not be described as cycle accurate on the strength of levels 1â€“3.

## Timing

The native clock accumulates integer microseconds against 985,248 PAL cycles per second, with 63 cycles Ã— 312 lines = 19,656 cycles per video frame. It retains fractional credit and host-stall debt. GameMaker's host refresh rate does not set the preservation clock.
