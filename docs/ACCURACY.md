...
Inner Sanctum's dog spawn enters the recovered animation record at $4e0c. Its close-contact transition similarly enters recovered record $4e2d instead of executable dispatcher $4e20. Encounter pursuit state is cleared on leaving the dog room so it cannot drive an ordinary enemy, and unresolved animation pointers now stop the actor with a visible diagnostic instead of crashing. Structural and native checks cover spawn, contact and room exit; this is not a complete original encounter replay.
