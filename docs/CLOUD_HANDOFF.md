...
- Inner Sanctum's dog uses recovered animation records $4e0c on entry and $4e2d on close contact. Do not restore executable dispatcher pointers $4e08/$4e20: they are not action records and caused missing actors or `record.flags` crashes. Leaving room 11 clears the dog-only pursuit mode.
